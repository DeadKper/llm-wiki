...
# Appended to <wiki>/.claude/hooks.log (gitignored). Never written during sentinel/confidential sessions.
...
def main():
    ...
    # Check both project cwd and wiki dir — user may place sentinel in either.
